sap.ui.define([
    ...
    return {
        print : async function(oBindingContext, aSelectedContexts) {
            ...
            this.editFlow.invokeAction('sanyo.print', mParameters)
            .then(function(result) {
                ...
                const oHtml = new HTML({
                    content: `<iframe src="${pdfUrl}" width="100%" height="700px"></iframe>`
                });
